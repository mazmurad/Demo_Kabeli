...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// +++ Мазанов М. 
	//СписокОбъектов.Добавить(Документы.ЖурналыУчетаКабельнойПродукции1);
	СписокОбъектов.Добавить(Документы.ЗаявкаНаМонтаж);
	СписокОбъектов.Добавить(Справочники.ЖурналыУчетаКабельнойПродукции);
	СписокОбъектов.Добавить(Документы.ЗаданияНаЗакупку);
...
Процедура ПриПолученииПодписейИПечатейответственного(ФизЛицо, ПодписиИПечати) Экспорт
		
	КомплектПодписей = Справочники.Подрядчик.ПолучитьПодписи(ФизЛицо);
	
	ПодписиИПечати.Вставить(ФизЛицо, КомплектПодписей);
