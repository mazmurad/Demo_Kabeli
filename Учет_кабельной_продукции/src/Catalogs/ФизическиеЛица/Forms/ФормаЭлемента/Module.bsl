...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыПоля2.ПутьКДаннымИзображения    = "АдресКартинки";
	ПараметрыПоля2.ОчищатьФайл               = Ложь;
	ПараметрыПоля2.ВыбиратьФайл              = Ложь;
	ПараметрыПоля2.ДобавлятьФайлы            = Ложь;
	ПараметрыПоля2.ПросматриватьФайл         = Ложь;
	ПараметрыПоля2.РедактироватьФайл         = Ложь;
