...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Объект.Статус = Перечисления.СтатусыКабельныхЛиний.Подготовлен;	
...
Процедура ПодписатьЗаявку(Команда)
	...
	Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыКабельныхЛиний.Подписан");	     
...
Процедура Отклонить(Команда)
	...
	Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыКабельныхЛиний.Отклонен");	
...
Процедура Отменить(Команда)
	...
	Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыКабельныхЛиний.Подготовлен");
