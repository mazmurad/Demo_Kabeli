...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтветственныеЛицаОрганизаций.Загрузить(РегистрыСведений.ОтветственныеЛица.ОтветственныеЛицаОрганизаций(Отбор));
...
Процедура ЗаписатьСписокОтветственных()
	...
	Для Каждого Элемент Из ОтветственныеЛицаОрганизаций Цикл
		...
		Попытка
		    ...
		    ЭлементБлокировки = Блокировка.Добавить("РегистрСведений.ОтветственныеЛица");
