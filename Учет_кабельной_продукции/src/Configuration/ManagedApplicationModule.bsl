...
Процедура ПриНачалеРаботыСистемы()
	...
	ПодключитьОбработчикОжидания("ВыполнитьОповещениеПользователяПоПросроченнымЗаявкаНаМонтажПриЗапуске", 5, Истина); 
	ПодключитьОбработчикОжидания("ВыполнитьОповещениеПользователяПоПросроченнымЗаявкаНаМонтажПериодически", 60); 
...
Процедура ВыполнитьОповещениеПользователяПоПросроченнымЗаявкаНаМонтажПриЗапуске() Экспорт
	
	ОповещениеПользователейКлиент.ОповеститьПользователейОПросроченныхЗаявокНаМонтаж();
	
КонецПроцедуры	  

Процедура ВыполнитьОповещениеПользователяПоПросроченнымЗаявкаНаМонтажПериодически() Экспорт
